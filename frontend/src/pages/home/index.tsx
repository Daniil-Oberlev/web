  ...
  return (
    <main className="content">
      ...
      <p>
        ...
        />
        Добро пожаловать в строительный магазин <strong>"Столплит"</strong> - место,
        где профессионалы и домашние мастера могут найти все необходимое для 
        качественного ремонта и строительства. Наш магазин работает уже более 5 лет и
        обслуживает как крупные строительные компании, так и частных клиентов.
      </p>
      <p>
        Мы предлагаем <em>широкий ассортимент</em> строительных материалов, профессиональные{" "}
        <strong>инструменты</strong> и сопутствующие товары. Наши консультанты -
        опытные специалисты строительной отрасли с многолетним практическим опытом.
      </p>
