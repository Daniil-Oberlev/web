...
export const Contacts = () => {
  ...
  useEffect(() => {
    ...
    script.async = true;
    script.src = 'https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A66602e8a473e36516939f83d512c492b70cc7b4ca0647f48226eea89086c34da&width=500&height=400&lang=ru_RU&scroll=true';
  ...
  return (
    <main className="content">
      <h2 className="content__header">КОНТАКТЫ СТРОИТЕЛЬНОГО МАГАЗИНА "СТОЛПЛИТ"</h2>
      <p>
        Мы всегда рады новым клиентам и партнерам! Магазин{" "}
        <strong>"Столплит"</strong>
        расположен в удобной транспортной развязке и легко доступен на личном 
        и общественном транспорте. Приезжайте знакомиться с нашим ассортиментом.
      </p>
      <p>
        Для консультации по товарам или оформления заказа
        свяжитесь с нами любым удобным способом. Наши менеджеры
        <em> ответят на все ваши вопросы</em> и помогут подобрать подходящие
        материалы для вашего проекта.
      </p>
      <h3 className="section__header" id="contacts">Контактная информация:</h3>
      ...
      <h3 className="section__header" id="work_hours">Режим работы:</h3>
      ...
      <h3 className="section__header" id="map">Мы на карте:</h3>
      ...
      <p>
        ...
        <strong> подобрать оптимальные решения</strong> для вашего ремонта 
        или строительства. Помните: качественные материалы -
